...
public interface IStaffFoundItemService
{
    ...
    Task<IEnumerable<StaffFoundItemResponse>> GetAllAsync(int? campusId = null, string? status = null, int? categoryId = null);
    Task<StaffFoundItemResponse?> GetByIdAsync(int id);
